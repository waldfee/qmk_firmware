...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMPAD] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, DE_7, DE_8,    DE_9,    DE_EQL,  _______, _______, KC_INS ,
    _______, _______, _______, _______, _______, DE_4, DE_5,    DE_6,    DE_MINS, _______, _______, KC_PAUS,
